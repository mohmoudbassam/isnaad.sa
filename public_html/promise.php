<?php session_start();  $_SESSION['Active']=4;
        ...
        <header class="header_area header_area_three">
            <nav class="navbar navbar-expand-lg menu_one">
                <div class="container custom_container p0">
                    <a class="navbar-brand" href="#"><img style="width:120px; height:auto;" src="image/Logo/<?php echo $row_Home['Logo']; ?>" srcset="image/Logo/<?php echo $row_Home['Logo']; ?>" srcset="image/Logo/<?php echo $row_Home['Logo']; ?>" srcset="image/Logo/<?php echo $row_Home['Logo']; ?> 2x" alt="logo"></a>
         ...
         <div class="row h_analytices_features_item flex-row-reverse">
                    ...
                    <div class="col-lg-12">
                        <div class="app_featured_content">
                               <h2 class="f_p f_size_30 f_700 t_color3 l_height45 pr_70 mb-30"> الوعد </h2>
                            <p class="f_600 t_color"> ما هو الوعد الذي لن يخلفه إسناد ؟ </p>
                         ...
                         <div class="col-lg-6 col-xs-6 col-ms-6">
                         <div class="h_features_img">
                            <img src="img/Artboard15.png" alt="">
                       ...
                       <div class="col-lg-6 col-xs-6 col-ms-6">
                           ...
                           <div class="media h_features_item">
                                ...
                                <div class="media-body">
                                    <h4 class="h_head" style="color:#dc4029;">العملية</h4>
                                    <p style="text-align:justify;">
                                  <?php echo $row_Home['Practical']; ?>
                            ...
                            <div class="media h_features_item">
                                ...
                                <div class="media-body">
                                    <h4 class="h_head" style="color:#dc4029;">الثقة</h4>
                                    <p style="text-align:justify;">
                                      <?php echo $row_Home['Confidence']; ?>
                                    </p>
                                </div>
                            </div>
                             ...
                             <div class="media h_features_item">
                                ...
                                <div class="media-body">
                                    <h4 class="h_head" style="color:#dc4029;"> النسيان </h4>
                                    <p style="text-align:justify;">
                                      <?php echo $row_Home['Forgetting']; ?>
                                    </p>
                                </div>
                            </div>
