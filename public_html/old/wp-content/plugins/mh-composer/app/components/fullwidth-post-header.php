<?php
class MHComposer_Component_Fullwidth_Post_Header extends MHComposer_Component {
	function init() {
		$this->name             = esc_html__( 'Full-width Post Header', 'mh-composer' );
		$this->slug             = 'mhc_fullwidth_post_header';
		$this->fullwidth        = true;
		$this->main_css_selector = '%%order_class%%.mhc_fullwidth_post_header';
		$this->defaults         = array();
...
new MHComposer_Component_Fullwidth_Post_Header;