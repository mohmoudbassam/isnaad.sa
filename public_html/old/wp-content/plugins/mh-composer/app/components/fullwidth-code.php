<?php
class MHComposer_Component_Fullwidth_Code extends MHComposer_Component {
	function init() {
		$this->name            = esc_html__( 'Full-width Code', 'mh-composer' );
		$this->slug            = 'mhc_fullwidth_code';
		$this->fullwidth       = true;
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$output = sprintf(
			'<div%2$s class="mhc_fullwidth_code mhc_module%3$s">
				%1$s
...
new MHComposer_Component_Fullwidth_Code;