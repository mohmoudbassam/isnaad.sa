(function($){
	window.mhc_align_vertical_modal = function( $prompt_modal, prompt_buttons_class ) {
		var $window = $(window),
			prompt_buttons_class = typeof prompt_buttons_class !== 'undefined' ? prompt_buttons_class : '.mhc_prompt_buttons',
		...
		$prompt_modal.addClass( 'mhc_auto_centerize_modal' );
	}
})(jQuery)