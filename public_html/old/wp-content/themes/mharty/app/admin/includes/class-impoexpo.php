					...
					<div id="mh-app-impoexpo-import">
						<div class="mh-app-modal-content">
							...
							<?php elseif ( 'post_type' === $this->instance->type ) : ?>
								<h3><?php esc_html_e( 'Select Mharty - Page Composer Layouts file to begin the import process:', MHARTY_APP_TEXTDOMAIN ); ?></h3>
							<?php else : ?>
							<h3><?php printf( esc_html__( 'Importing %s file will overwrite all current data. Please proceed with caution!', MHARTY_APP_TEXTDOMAIN ), $this->instance->name ); ?></h3>
							<?php endif; ?>
							...
							<form class="mh-app-impoexpo-import-form">
                           	...
                           	<?php if ( 'post_type' !== $this->instance->type ) : ?>
								<small><?php esc_html_e( 'Recommended: Export a backup of your settings.', MHARTY_APP_TEXTDOMAIN ); ?></small>
							<?php endif; ?>
                            <?php if ( 'post_type' === $this->instance->type ) : ?>
								<small><?php esc_html_e( 'Note: Large files or files contain large images may take several minutes to upload.', MHARTY_APP_TEXTDOMAIN ); ?></small>
                            <?php endif; ?>
						</div>
