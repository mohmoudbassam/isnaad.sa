...
?>
<div id="main-content">
<?php do_action('mh_author_profile');?>
	<div class="container">
		<div id="content-area" class="clearfix">
			<div id="left-area">
				...
				<?php
				//archive title
				if ('on' == mh_get_option( 'mharty_archive_title', 'off' ) ): ?>
						<div class="mh_main_title"><h1><?php the_archive_title(); ?></h1></div>
				<?php endif; ?>
                        ...
                        <article id="post-<?php the_ID(); ?>" <?php post_class( 'mhc_post' . $show_loveit_class . $meta_info_position_class . $no_thumb_class); ?>>
							...
							if ( ! in_array( $post_format, array( 'link', 'audio', 'quote', 'gallery' ) ) ) : ?>
								...
								<div class="mhc_post_content">
                                    ...
                                    <?php do_action('mh_author_after_post'); ?>
