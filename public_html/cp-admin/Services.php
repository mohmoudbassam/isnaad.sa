...
var url="Delete_Service.php?id="+id;	
var xmlhttp;
                        ...
                        <div class="col-md-12">
                            <div class="x_panel">
                                ...
                                <?php 
								 ...
								 echo' <h4 style="text-align:right; direction:rtl; float:right;"> خدماتنا &nbsp;</h4>';
								   echo"<h4 style='text-align:right; direction:rtl; float:right;'>";
								 $sql1="select Count(*) as num from service";
								 $result1=mysql_query($sql1,$link);
								 $row1=@mysql_fetch_array($result1);
								 echo" ( "; echo $row1['num']; echo '<span style="color:Blue;"> خدمة </span>';
								 echo" ) ";
								 echo"</h4>";
...
<br>
                       ...
                       <div style="float:right;"> <a href="New_Service.php" class="btn btn-primary btn-xs"><i class="fa fa-archive"></i> خدمة جديدة </a> </div>
