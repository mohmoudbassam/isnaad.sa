...
$sql_P="select * from comment where idComment='$id'";
$result_P=mysql_query($sql_P,$link);
$row_P=mysql_fetch_array($result_P);

if ($row_P['Sho']==1)
{
 $sql="UPDATE  comment  SET Sho='2',Seen='2' Where idComment=$id";																
 $result=mysql_query($sql,$link);	
}
else
{
$sql="UPDATE  comment  SET Sho='1',Seen='2' Where idComment=$id";																
 $result=mysql_query($sql,$link);	
