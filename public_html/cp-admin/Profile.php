    ...
    <div class="container body">
         ...
         <div class="main_container">
          ...
          <?php   include("../include/Head_Menue.php"); ?>
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title" >
                                    <h4 style="text-align:right; float:right;">تعديل العضو  </h4>
            ...
            <?php
								    ...
								    $Member= $_GET['id'];
									 $sql21="update  user Set seen='2' Where idUser='$Member'";
		                             $result21=mysql_query($sql21,$link);
								  
								  
                                    
		                             $sql="select * from user  Where idUser='$Member'";
                                   ...
                                   ?>
                                            ...
                                            <form class="form-horizontal form-label-left" novalidate id="demo-form2" method="post" action="Edit_Member.php" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                                   
                                   
                                    <form id="demo-form2" action="Edit_Member.php" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
        ...
        $("body").on("click", "#btnUpload", function () {
            ...
            return true;
                                      ...
                                      <div class="item form-group">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                  <div class="avatar-view " style="margin-left:40%;" title="تغير الصورة">
                                                     ...
                                                     <img src="../image/User/<?php echo $row['Image']; ?>" alt="Avatar">
                                                </div>
                                            </div>
                                        </div>
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                             <input type="text"  id="Username" name="Username" value="<?php echo $row['Username']; ?>" data-validate-length-range="5" class=                             "optional form-control col-md-7 col-xs-12">
                             </div>
                             </div>
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                             <input type="text" id="Company" name="Company" value="<?php echo $row['Company']; ?>" required class="form-control col-md-7 col-xs-12">
                             </div>
                             </div>
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                           <input type="text" id="Linked" name="Linked" value="<?php echo $row['Linked']; ?>"  class="form-control col-md-7 col-xs-12">
                           </div>
                           </div>
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                           <input id="password" type="password" value="<?php echo $row['Password']; ?>" name="password" data-validate-length="6,8" class=                           "form-control col-md-7 col-xs-12" required>
                           </div>
                           </div>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                  <select class="select2_single form-control" name="Type" id="Type" style="height:43px;" tabindex="-1">
                                   <?php	   
                                      if( $row['Type']==1)		
                                       echo" <option value='1' selected> عادي</option>";
                                      else
                                       echo" <option value='1'> عادي</option>";
  
  
                                      
  
                                       if( $row['Type']==2)		
                                       echo" <option value='2' selected>فنان</option>";
                                       else
                                       echo" <option value='2'>فنان</option>";
                                  ...
                                  <select class="select2_single form-control" name="Gender" id="Gender" style="height:43px;" tabindex="-1">
                                   <?php	   
                                      if( $row['Gender']==1)		
                                       ...
                                       if( $row['Gender']==2)		
                                       echo" <option value='2' selected>أنثى</option>";
                                       else
                                       echo" <option value='2'>أنثى</option>";
                         ...
                         <textarea cols="60" id="Address" name="Address" style="width:72%"><?php echo $row['Address']; ?></textarea>
                         </div>
                         </div>
		                 <br>
                         ...
                         <div class="col-md-8 col-sm-8 col-xs-12">  
                         <textarea cols="60" id="Address_E" name="Address_E" style="width:72%"><?php echo $row['Address_E']; ?></textarea>
                         </div>
                         </div>
		                 <br>
