 ...
 if($_FILES["Image"]["size"]!=0)
      {
           ...
           || ($_FILES["Image"]["type"] == "image/pjpeg")))
			     ...
			     $sql="INSERT INTO team(Name,Name_E,Mobile,Job_E,Job,Email,Sho,Image,Info_E,Info)VALUES('$Name','$Name_E','$Mobile','$Job_E','$Job','$Email','$Sho','$filename','$Info_E','$Info')";
		...
		{				
                    $_SESSION['Done']=1;
					echo "<META HTTP-EQUIV='Refresh' Content='0;URL=New_Team.php'>";
