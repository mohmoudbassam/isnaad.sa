...
function contains($substring, $string) {
 ...
 if($_FILES["Image"]["size"]!=0)
	...
	echo "<META HTTP-EQUIV='Refresh' Content='0;URL=New.php?id=$id'>";
								}
					  else
	                            {
                                    $filename="";
				 ...
				 if(contains(".jpg",$filename)|| contains(".JPG",$filename)|| contains(".jpeg",$filename) || contains(".JPEG",$filename)||contains(".PNG",$filename)||contains(".png",$filename)||contains(".gif",$filename))
								                                  ...
								                                  {
                        move_uploaded_file($_FILES["Image"]["tmp_name"],"../image/News/$filename");
																
																	
	    $sql="UPDATE  news  SET Name='$Name',Name_E='$Name_E',Info='$Info',Info_E='$Info_E',Sho='$Sho',Image='$filename' Where idNews=$id";																
   ...
   echo "<META HTTP-EQUIV='Refresh' Content='0;URL=New.php?id=$id'>";
	  ...
	  { 
		 ...
		 $sql="UPDATE  news  SET Name='$Name',Name_E='$Name_E',Info='$Info',Info_E='$Info_E',Sho='$Sho' Where idNews=$id";																
         $result=mysql_query($sql,$link);
