 ...
 if($_FILES["Image"]["size"]!=0)
      {
           ...
           || ($_FILES["Image"]["type"] == "image/pjpeg")))
			...
			$sql="INSERT INTO slider(Name,Name_E,Info,Info_E,Sho,Link,Address)VALUES('$Name','$Name_E','$Info','$Info_E','$Sho','$filename','$Address')";
		...
		{
			 $_SESSION['Done']=1;
  			 echo "<META HTTP-EQUIV='Refresh' Content='0;URL=New_Slider.php'>";
