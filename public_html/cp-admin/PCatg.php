...
var url="Delete_PCatg.php?id="+id+"&Section="+Section;	;	
var xmlhttp;
                        ...
                        <div class="col-md-12">
                            <div class="x_panel">
                                ...
                                <?php
								 ...
								 $Section= $_GET['id'];
								 $sql_Sec="select * from projsection where idProjsection='$Section' ";
                                 $result_Sec=mysql_query($sql_Sec,$link);
								 $row_Sec=mysql_fetch_array($result_Sec);

                                   echo' <h4 style="text-align:right; float:right;">'.$row_Sec['Name'].'</h4>';
									?>
                                    <br>
<br>
<br>
<br>
                       ...
                       <div style="float:right;"> <a href="New_PCatg.php?id=<?php echo $Section; ?>" class="btn btn-primary btn-xs"><i class="fa fa-archive"></i> تصنيف جديد </a> </div>
                                ...
                                <div class="x_content">
                                 ...
                                 <a href="Projects.php?id='.$row_Cat['idProjcateg'].'" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> الكائنات </a>
