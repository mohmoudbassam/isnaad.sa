...
function Delete(Project,Num)
{

var url="ajax/Edit_Project.php?Project="+Project+"&Num="+Num;
    ...
    <div class="container body">
         ...
         <div class="main_container">
          ...
          <?php   include("../include/Head_Menue.php"); ?>
           ...
           <?php
           $project= $_GET['id'];
		   $sql="select * from project  Where idProject='$project'";
		   $result=mysql_query($sql,$link);
		   $row=mysql_fetch_array($result);
           ?>
                                    <form id="demo-form2" action="Edit_Project.php" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                                     <input type="hidden" name="id"  id="hiddenField"   value="<?php echo $project; ?>"/>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">إسم الكائن  <span class="required">*</span>
                                            </label>
                ...
                <input type="text" style="text-align:right; direction:rtl;" id="Name" name="Name" value="<?php echo $row['Name']; ?>" required class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">×Object Name <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
			 ...
			 <div class="form-group">
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Map">تفاصيل الكائن<span class="required">*</span>  </label>
                ...
                <textarea cols="60" id="Info" name="Info" style="width:72%"><?php  echo $row['Info']; ?> </textarea>
                  ...
                  <div class="form-group">
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Map">Object Details<span class="required">*</span>  </label>
                <div class="col-md-8 col-sm-8 col-xs-12">  
...
<br>
         ...
         <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="Visit" name="Visit" value="<?php echo $row['Visit']; ?>"  class="form-control col-md-7 col-xs-12">
                </div>
            </div>
...
<div class="form-group">
               ...
               <tr>
    <td  style="vertical-align:middle;" align="right" >   <span class="btn btn-file" style="font-size:14px; "><input  class="btn btn-success" type="file" name="Image" id="Image"/></span></td>
