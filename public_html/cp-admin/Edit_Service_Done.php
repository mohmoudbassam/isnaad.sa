...
function contains($substring, $string) {
 ...
 if($_FILES["Image"]["size"]!=0)
	...
	echo "<META HTTP-EQUIV='Refresh' Content='0;URL=Service.php?id=$id'>";
								}
					  else
	                            {
                                    $filename="";
	    ...
	    $sql="UPDATE  service  SET Name='$Name',Name_E='$Name_E',Info='$Info',Info_E='$Info_E',Sho='$Sho',Image='$filename' Where idService=$id";																
   ...
   echo "<META HTTP-EQUIV='Refresh' Content='0;URL=Service.php?id=$id'>";
	  ...
	  { 
		 ...
		 $sql="UPDATE  service  SET Name='$Name',Name_E='$Name_E',Info='$Info',Info_E='$Info_E',Sho='$Sho' Where idService=$id";																
         $result=mysql_query($sql,$link);
