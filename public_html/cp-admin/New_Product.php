                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title" >
                                    <h4 style="text-align:right; float:right;">إضافة كائن  </h4>
...
<br>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="Link1" name="Link1" value=""  class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="Link2" name="Link2" value=""  class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="Link3" name="Link3" value=""  class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
...
<div class="form-group">
               ...
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Map">صورة الكائن  <span class="required"></span>  </label>
