 ...
 if($_FILES["Image"]["size"]!=0)
      {
           ...
           || ($_FILES["Image"]["type"] == "image/pjpeg")))
			...
			$sql="INSERT INTO brand(Name,Name_E,Sho,Image)VALUES('$Name','$Name_E','$Sho','$filename')";
		...
		{
			 $_SESSION['Done']=1;
  			 echo "<META HTTP-EQUIV='Refresh' Content='0;URL=New_Brand.php'>";
