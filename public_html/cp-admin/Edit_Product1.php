...
$F_Catg=$_SESSION['Catg'];	
	...
	$F_Catg=1;
		...
		$sql="UPDATE product  SET Name='$Name',Company='$Company',Name_E='$Name_E',Info='$Info',Info_E='$Info_E',Sho='$Sho',Sold='$Sold',Price='$Price',F_User='$F_User',F_Category='$F_Catg',E_Date='$E_Date',Tags='$Tags',Tags_E='$Tags_E' Where idProduct='$id'";
