...
<body class="nav-md">
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title" >
                                    <h4 style="text-align:right; float:right;">تعديل الخدمة  </h4>
  ...
  <?php
           ...
           $Service= $_GET['id'];
		   $sql="select * from service  Where idService='$Service'";
...
?>
                      ...
                      <form id="demo-form2" action="Edit_Service_Done.php" method="post" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
        ...
        $("body").on("click", "#btnUpload", function () {
            ...
            return true;
              ...
              <input type="hidden" name="id"  id="hiddenField"   value="<?php echo $Service; ?>"/>

                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">إسم الخدمة  <span class="required">*</span>
                                            </label>
                ...
                <input type="text" style="text-align:right; direction:rtl;" id="Name" name="Name" value="<?php  echo $row['Name']; ?>" required class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Service Name <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
...
<br>
			 ...
			 <div class="form-group">
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Map">تفاصيل الخدمة<span class="required">*</span>  </label>
                ...
                <textarea cols="60" id="Info" name="Info" style="width:72%"><?php  echo $row['Info']; ?> </textarea>
                  ...
                  <div class="form-group">
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Map">Service Details<span class="required">*</span>  </label>
                <div class="col-md-8 col-sm-8 col-xs-12">  
...
<br>
    ...
    <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">ظهور الخدمة</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
...
<div class="form-group">
               ...
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Map">صورة الخدمة<span class="required"></span>  </label>
...
" 
 src="../image/Services/<?php echo $row['Image']; ?>"  /></td>
  </tr>
  </table>
                </div> 
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                <button type="submit"  id="btnUpload"  class="btn btn-success">تعديل الخدمة</button>
                                            </div>
                                        </div>
