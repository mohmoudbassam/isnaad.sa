...
var url="Search_Project.php?Word="+Word+"&Catg="+Catg;	
var xmlhttp;
...
var url="Delete_Project.php?id="+id+"&Catg="+Catg;	
var xmlhttp;
if (window.XMLHttpRequest)
  {// code for IE7+, Firefox, Chrome, Opera, Safari
  xmlhttp=new XMLHttpRequest();
                    ...
                    <div class="page-title">
                        ...
                        <div class="title_right">
                            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                                ...
                                <?php
								 $Catg= $_GET['id'];
                                    echo'<input type="search" id="Word" name="Word" style="direction:rtl;" class="form-control"   placeholder="إبحث عن كائن">';
									?>
                        ...
                        <div class="col-md-12">
                            <div class="x_panel">
								...
								/// رقم التصنيف
								 ...
								 $sql_Catg="select * from projcateg where idProjcateg='$Catg' ";
                                 $result_Catg=mysql_query($sql_Catg,$link);
								 $row_Catg=mysql_fetch_array($result_Catg);
								 
								 $o=$row_Catg['F_Section'];
								  $sql_S="select * from projsection where idProjsection='$o' ";
								 ...
								 $sql1="select Count(*) as num from project  where F_Category='$Catg'";
...
<br>
                       ...
                       <div style="float:right;"> <a href="New_Project.php" class="btn btn-primary btn-xs"><i class="fa fa-archive"></i> كائن جديد </a> </div>
                                   ...
                                   <div id="myDiv">  
                                    ...
                                    <table class="table table-striped projects">
                                        ...
                                        <tbody>
										 ...
										 $sql_P="select * from project where F_Category='$Catg' order by idProject DESC ";
