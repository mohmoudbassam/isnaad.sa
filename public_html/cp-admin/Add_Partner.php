 ...
 if($_FILES["Image"]["size"]!=0)
      {
           ...
           || ($_FILES["Image"]["type"] == "image/pjpeg")))
                       ...
                       if ($_FILES["Image"]["error"] > 0)
                                {
									...
									header("location:New_Partner.php");
								}
					  else
	                            {
                                    $filename="";
			...
			$sql="INSERT INTO partner(Name,Name_E,Mobile,Email,Sho,Image)VALUES('$Name','$Name_E','$Mobile','$Email','$Sho','$filename')";
			...
			if (!$result) {	
             ...
             window.history.back();
					...
					{
						$_SESSION['Done']=1;														  																															 $_SESSION['Done']=1;

					echo "<META HTTP-EQUIV='Refresh' Content='0;URL=New_Partner.php'>";
					}
