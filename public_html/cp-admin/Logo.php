                ...
                <div class="">
                    ...
                    <div class="page-title">
                        <div class="title_right">
                            <h4 style="text-align:right; ">شعار الشركة</h4>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                       <form id="demo-form2" method="post" action="Edit_Logo.php" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
...
" 
 src="../image/Logo/<?php echo $row['Logo']; ?>"  /></td>
  </tr>
  </table>
                </div> 
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                <button type="submit" id="btnUpload"  class="btn btn-success">رفع</button>
                                            </div>
                                        </div>
