...
<body class="nav-md">
  ...
  <?php
           ...
           $Partner= $_GET['id'];
		   $sql="select * from partner  Where idPartner='$Partner'";
...
?>
                      ...
                      <form id="demo-form2" action="Edit_Partner_Done.php" method="post" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
        ...
        $("body").on("click", "#btnUpload", function () {
            ...
            return true;
                    ...
                    <input type="hidden" name="id"  id="hiddenField"   value="<?php echo $Partner; ?>"/>
...
" 
 src="../image/Partner/<?php  echo $row['Image']; ?>"  /></td>
  </tr>
  </table>
                </div> 
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                <button type="submit" id="btnUpload"  class="btn btn-success">تعديل الشريك</button>
                                            </div>
                                        </div>
