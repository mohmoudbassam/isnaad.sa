...
<body class="nav-md">
  ...
  <?php
           ...
           $Team= $_GET['id'];
		   $sql="select * from team  Where idTeam='$Team'";
...
?>
                      ...
                      <form id="demo-form2" action="Edit_Team_Done.php" method="post" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
        ...
        $("body").on("click", "#btnUpload", function () {
            ...
            return true;
                    ...
                    <input type="hidden" name="id"  id="hiddenField"   value="<?php echo $Team; ?>"/>
                ...
                <input type="text" style="text-align:right; direction:rtl;" id="Name" name="Name" value="<?php  echo $row['Name']; ?>" required class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="Job" name="Job" value="<?php  echo $row['Job']; ?>" required class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="Job_E" name="Job_E" value="<?php  echo $row['Job_E']; ?>" required class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="Mobile" name="Mobile" value="<?php  echo $row['Mobile']; ?>"  class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
...
" 
 src="../image/Team/<?php  echo $row['Image']; ?>"  /></td>
  </tr>
  </table>
                </div> 
