                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title" >
                                    <h4 style="text-align:right; float:right;">صورة جديدة  </h4>
                           ...
                           <form id="demo-form2" method="post" action="Add_Slider.php" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <input type="text" style="text-align:right; direction:rtl;" id="Name" name="Name" required class="form-control col-md-7 col-xs-12">
                                    ...
                                    <br>
                                     <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="Address" name="Address" value=""  class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
<br>
