...
<body class="nav-md">
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title" >
                                    <h4 style="text-align:right; float:right;">تعديل التصنيف  </h4>
  ...
  <?php
           ...
           $catg= $_GET['id'];
		   $sql="select * from projcateg  Where idProjcateg='$catg'";
...
?>
                         ...
                         <form id="demo-form2" method="post"  action="Edit_PCatg_Done.php" data-parsley-validate class="form-horizontal form-label-left">
                                         <input type="hidden" name="id"  id="hiddenField"   value="<?php echo $catg; ?>"/>
