...
<body class="nav-md">
  ...
  <?php
           ...
           $Section= $_GET['id'];
		   $sql="select * from section  Where idSection='$Section'";
		   $result=mysql_query($sql,$link);
		   $row=mysql_fetch_array($result);
	

?>
                                    <form id="demo-form2" method="post"  action="Edit_Section_Done.php" data-parsley-validate class="form-horizontal form-label-left">
