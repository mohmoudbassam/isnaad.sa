...
<body class="nav-md">
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title" >
                                    <h4 style="text-align:right; float:right;">قسم جديد </h4>
    ...
    <form id="demo-form2" action="Add_PSection.php" method="post" data-parsley-validate class="form-horizontal form-label-left" >
                ...
                <input type="text" style="text-align:right; direction:rtl;" id="Name" name="Name" required class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select id="Sho" name="Sho" class="select2_single form-control" tabindex="-1">
