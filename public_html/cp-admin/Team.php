                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php 
								 ...
								 echo' <h4 style="text-align:right; direction:rtl; float:right;"> فريق العمل &nbsp;</h4>';
								   echo"<h4 style='text-align:right; direction:rtl; float:right;'>";
								 $sql1="select Count(*) as num from team";
								 $result1=mysql_query($sql1,$link);
								 $row1=@mysql_fetch_array($result1);
								 echo" ( "; echo $row1['num']; echo '<span style="color:Blue;"> شخص </span>';
								 echo" ) ";
								 echo"</h4>";
...
<br>
                       ...
                       <div style="float:right;"> <a href="New_Team.php" class="btn btn-primary btn-xs"><i class="fa fa-archive"></i> شخص جديد </a> </div>
                                ...
                                <div class="x_content">
                                 ...
                                 <div id="myDiv"> 
                                  ...
                                  <?php 
		                             $sql="select * from team order by idTeam Desc ";
