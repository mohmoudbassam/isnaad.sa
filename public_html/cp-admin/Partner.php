...
var url="Delete_Partner.php?id="+id;	
var xmlhttp;
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h4 style="text-align:right; float:right;">شركائنا   </h4>
                                    <br>
<br>
<br>
<br>

                       <div style="float:right;"> <a href="New_Partner.php" class="btn btn-primary btn-xs"><i class="fa fa-archive"></i> شريك جديد  </a> </div>
