...
$Project=$_GET["Project"];
	...
	$sql="UPDATE project  SET File='' Where idProject='$Project'";
 ...
 ';
  ...
  $q35="select * from project where idProject='$Project'";
...
{
    echo '<td>'; 
echo" <img src='img/Delete-icon.png'  width='20' height='20' style='margin-bottom:62px;  cursor:pointer;'  onclick='Deletef(".$Project.")'/> ";
