...
$Product=$_GET["Product"];
	...
	$sql="UPDATE category  SET File='' Where idCategory='$Product'";
 ...
 ';
  ...
  $q35="select * from category where idCategory='$Product'";
...
{
    echo '<td>'; 
echo" <img src='img/Delete-icon.png'  width='20' height='20' style='margin-bottom:62px;  cursor:pointer;'  onclick='Deletef(".$catg.")'/> ";
