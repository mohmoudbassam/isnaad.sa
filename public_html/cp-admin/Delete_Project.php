...
$Catg=$_GET["Catg"];
 ...
 $q35="select * from project_image where F_Project='$id'";
 $r35=mysql_query($q35,$link);
 while($row35=@mysql_fetch_array($r35))
	{
     unlink('../image/Project/'.$row35['Link'].'');

	}

$result1=mysql_query("DELETE FROM project_image
where F_Project=$id",$link);



$result1=mysql_query("DELETE FROM project
where idProject=$id",$link);
