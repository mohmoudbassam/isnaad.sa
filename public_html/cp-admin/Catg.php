                        ...
                        <div class="col-md-12">
                            <div class="x_panel">
                                ...
                                <?php
								 ...
								 $Section= $_GET['id'];
								 $sql_Sec="select * from section where idSection='$Section' ";
...
<br>
                       ...
                       <div style="float:right;"> <a href="New_Catg.php?id=<?php echo $Section; ?>" class="btn btn-primary btn-xs"><i class="fa fa-archive"></i> تصنيف جديد </a> </div>
                                ...
                                <div class="x_content">
                                 ...
                                 <a href="Products.php?id='.$row_Cat['idCategory'].'" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> الكائنات </a>
