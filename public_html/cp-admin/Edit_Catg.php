...
<body class="nav-md">
  ...
  <?php
           ...
           $catg= $_GET['id'];
		   $sql="select * from category  Where idCategory='$catg'";
...
?>
                         ...
                         <form id="demo-form2" method="post"  action="Edit_Catg_Done.php" data-parsley-validate class="form-horizontal form-label-left">
