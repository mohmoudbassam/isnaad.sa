                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title" >
                                    <h4 style="text-align:right; float:right;">إضافة المنتج  </h4>
								...
								?>
                                   <form id="demo-form2" action="Add_Product.php" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
        ...
        $("body").on("click", "#btnUpload", function () {
            ...
            return true;
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">إسم المنتج  <span class="required">*</span>
                                            </label>
                ...
                <input type="text" style="text-align:right; direction:rtl;" id="Name" name="Name" required class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group">
                                           ...
                                           <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">الشركة المصنعة  <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text"  id="Company" name="Company" value="" required class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
...
<br>
			 ...
			 <div class="form-group">
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Map">تفاصيل المنتج<span class="required">*</span>  </label>
				...
				<textarea cols="60" id="Info" name="Info" style="width:72%"></textarea>
                  ...
                  <div class="form-group">
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Map">Product Details<span class="required">*</span>  </label>
                <div class="col-md-8 col-sm-8 col-xs-12">  
...
<br>
                                     ...
                                     <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">سعر المنتج <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
...
<br>
                                       ...
                                       <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">صلاحية الإعلان</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select style="height:40px;" class="select2_single form-control" name="Type" id="Type" tabindex="-1">
                                     ...
                                     <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">وزن المنتج <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
...
<br>
                                     <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">المشاهدات <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="Visit" name="Visit"  class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
...
<br>
                                 ...
                                 <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">التصويت <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="Rate" name="Rate"  class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
...
<br>
     ...
     <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">الكمية <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
...
<br>
                                         ...
                                         <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">ظهور المنتج</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select style="height:40px;" class="select2_single form-control" name="Sho" id="Sho" tabindex="-1">
...
<div class="form-group">
               ...
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Map">صورة المنتج<span class="required"></span>  </label>
