                        ...
                        <div class="col-md-12">
                            <div class="x_panel">
                                ...
                                <?php 
								 ...
								 echo' <h4 style="text-align:right; direction:rtl; float:right;"> أخبارنا &nbsp;</h4>';
								   echo"<h4 style='text-align:right; direction:rtl; float:right;'>";
								 $sql1="select Count(*) as num from news";
								 $result1=mysql_query($sql1,$link);
								 $row1=@mysql_fetch_array($result1);
								 echo" ( "; echo $row1['num']; echo '<span style="color:Blue;"> خبر </span>';
								 echo" ) ";
								 echo"</h4>";
...
<br>
                       ...
                       <div style="float:right;"> <a href="New_New.php" class="btn btn-primary btn-xs"><i class="fa fa-archive"></i> خبر جديد </a> </div>
                                            ...
                                            <tr>
                                               ...
                                               <td>
                                                ...
                                                <td>
													...
													<a href="Comments.php?id='.$row['idNews'].'" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> التعليقات </a>
                                                </td>
                                            </tr>';
                                           }
											?>
