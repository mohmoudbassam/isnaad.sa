...
<body class="nav-md">
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title" >
                                    <h4 style="text-align:right; float:right;">تعديل القسم  </h4>
  ...
  <?php
           ...
           $Section= $_GET['id'];
		   $sql="select * from projsection  Where idProjsection='$Section'";
		   $result=mysql_query($sql,$link);
		   $row=mysql_fetch_array($result);
	

?>
                                    <form id="demo-form2" method="post"  action="Edit_PSection_Done.php" data-parsley-validate class="form-horizontal form-label-left">
                                         <input type="hidden" name="id"  id="hiddenField"   value="<?php echo $Section; ?>"/>


                                        <div class="form-group">
                                           <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">إسم القسم  <span class="required">*</span>
                                            </label>
                ...
                <input type="text" style="text-align:right; direction:rtl;" id="Name" name="Name" value="<?php echo $row['Name'];  ?>" required class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Section Name <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">ظهور القسم</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                <button type="submit"  class="btn btn-success">تعديل القسم</button>
                                            </div>
                                        </div>
