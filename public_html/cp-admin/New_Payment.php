         ...
         <div class="main_container">
           ...
           <!-- top navigation -->
            ...
            <div class="right_col" role="main">
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title" >
                                    <h4 style="text-align:right; float:right;">دفعة جديدة  </h4>
                                ...
                                <div class="x_content">
                                   ...
                                   <form id="demo-form2" action="Add_Payment.php" method="post"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <input type="number" min="1" style="text-align:right; direction:rtl;" id="Val" name="Val" required class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
