...
<body class="nav-md">
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title" >
                                    <h4 style="text-align:right; float:right;">تعديل العميل  </h4>
  ...
  <?php
           ...
           $Customer= $_GET['id'];
		   $sql="select * from customer  Where idCustomer='$Customer'";
...
?>
                      ...
                      <form id="demo-form2" action="Edit_Customer_Done.php" method="post" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
        ...
        $("body").on("click", "#btnUpload", function () {
            ...
            return true;
                    ...
                    <input type="hidden" name="id"  id="hiddenField"   value="<?php echo $Customer; ?>"/>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">إسم العميل  <span class="required">*</span>
                                            </label>
                ...
                <input type="text" style="text-align:right; direction:rtl;" id="Name" name="Name" value="<?php  echo $row['Name']; ?>" required class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="Email" name="Email" value="<?php  echo $row['Email']; ?>"  class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="Website" name="Website" value="<?php  echo $row['Website']; ?>"  class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
...
<br>
    <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">ظهور العميل</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
...
<div class="form-group">
               ...
               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Map">صورة العميل<span class="required"></span>  </label>
...
" 
 src="../image/Customer/<?php  echo $row['Image']; ?>"  /></td>
  </tr>
  </table>
                </div> 
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                <button type="submit" id="btnUpload"  class="btn btn-success">تعديل العميل</button>
                                            </div>
                                        </div>
