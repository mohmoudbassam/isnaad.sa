...
$F_Catg=$_SESSION['Catg'];	
	...
	$F_Catg=1;
			...
			$sql="INSERT INTO project(Name,Name_E,Info,Info_E,Sho,Price,Visit,F_Customer,F_Category)VALUES('$Name','$Name_E','$Info','$Info_E',$Sho,$Price,$Visit,$F_Customer,$F_Catg)";
 ...
 if($_FILES["Image"]["size"]!=0)
      {
           ...
           || ($_FILES["Image"]["type"] == "image/pjpeg")))
			...
			$sql="INSERT INTO project_image(Name,Link,Num,F_Project)VALUES($ip,'$filename',1,$ip)";
			$result=mysql_query($sql,$link);
	  ...
	  {   $image="1.jpg";
           ...
           $sql="INSERT INTO project_image(Name,Link,Num,F_Project)VALUES('$ip','$image',1,$ip)";
		   $result=mysql_query($sql,$link);		
