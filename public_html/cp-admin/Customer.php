...
var url="Delete_Customer.php?id="+id;	
var xmlhttp;
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php 
								 ...
								 echo' <h4 style="text-align:right; direction:rtl; float:right;"> عملائنا &nbsp;</h4>';
								   echo"<h4 style='text-align:right; direction:rtl; float:right;'>";
								 $sql1="select Count(*) as num from customer";
								 $result1=mysql_query($sql1,$link);
								 $row1=@mysql_fetch_array($result1);
								 echo" ( "; echo $row1['num']; echo '<span style="color:Blue;"> عميل </span>';
								 echo" ) ";
								 echo"</h4>";
...
<br>
                       ...
                       <div style="float:right;"> <a href="New_Customer.php" class="btn btn-primary btn-xs"><i class="fa fa-archive"></i> عميل جديد </a> </div>
