<?php session_start();  $_SESSION['Active']=5;
    ...
    <div class="body_wrapper">
        <header class="header_area header_area_three">
            <nav class="navbar navbar-expand-lg menu_one">
              ...
              <section class="seo_subscribe_area" style="background:#FFFFFF;">
            <div class="overlay_img"></div>
            
            <div class="container">
               <div class="col-lg-8" style="float:left;">
                        <div class="app_featured_content">
                            <h2 class="f_p f_size_20 f_700 t_color3 l_height45 pr_70 mb-30"> ميزتنا الإستثنائية !   </h2>
                           

                            <p class="f_400">
                            
                               <?php echo $row_Home['Feature']; ?>
                            </p>
